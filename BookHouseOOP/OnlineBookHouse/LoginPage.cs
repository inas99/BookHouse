...
namespace BookHouseOOP
{
    ...
    {
        SqlConnection connection = new SqlConnection(@"Server=tcp:dboopsql.database.windows.net,1433;Initial Catalog=BookHouse;Persist Security Info=False;User ID=myadmin;Password=Inas2020;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
        public LoginPage()
        {
            InitializeComponent();
