...
namespace BookHouseOOP
{
    public partial class BookShopForm : Form, IMessageFilter
    {
        ...
        */
        ...
        {
            dgvUsers.DataSource = dbHelper.getAllItemsForAClassFromATableByItsType(typeof(BookHouseOOP.UserClass));
        }
        /**
        ...
        {
            dgvBooks.DataSource = dbHelper.getAllItemsForAClassFromATableByItsType(typeof(BookHouseOOP.BookClass));
        }
        /**
        ...
        {
            dgvMusicCDs.DataSource = dbHelper.getAllItemsForAClassFromATableByItsType(typeof(BookHouseOOP.MusicCDsClass));
        ...
        {
            dgvMagazine.DataSource = dbHelper.getAllItemsForAClassFromATableByItsType(typeof(BookHouseOOP.MagazineClass));
        }
        ...
        */
        ...
        private void btnDeleteBooks_Click(object sender, EventArgs e)
        {
            ...
            AdminUserClass adminOps = AdminUserClass.Instance;
            bool affected = adminOps.deleteProduct(typeof(BookHouseOOP.BookClass), txtBookId.Text.ToString());
        ...
        */
        private void btnDeleteMusicCDs_Click(object sender, EventArgs e)
        {
            ...
            AdminUserClass adminOps = AdminUserClass.Instance;
            bool affected = adminOps.deleteProduct(typeof(BookHouseOOP.MusicCDsClass), txtMusicCDsId.Text.ToString());
        ...
        */
        ...
        private void btnDeleteMagazine_Click(object sender, EventArgs e)
        {
            ...
            AdminUserClass adminOps = AdminUserClass.Instance;
            bool affected = adminOps.deleteProduct(typeof(BookHouseOOP.MagazineClass), txtMagazineId.Text.ToString());
        ...
        */
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            lblNavigator.Text = "Shopping Cart";
        }

        private void pbAdminPanel_Click(object sender, EventArgs e)
        {
            tabControlGeneral.SelectedTab = tabAdminPanel;
            lblNavigator.Text = "Admin Panel";
        }
        /** @brief button exit
      ...
      */
        ...
        */
        ...
        private string savePDF()
        {
            ...
            sfdUserExport.Title = "Save PDF File";
            sfdUserExport.Filter = " pdf files (*.pdf)|*.pdf";
            if (sfdUserExport.ShowDialog() == DialogResult.OK)
            {
                return sfdUserExport.FileName;
            }
            else
                return null;
        ...
        private void btnAddMusicCDs_Click(object sender, UICuesEventArgs e)
        {

        }

        private void btnAddMusicCDs_Click_1(object sender, EventArgs e)
        {
